...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '智算科技', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI 科技博主，如果有冒犯或者失准得请指教，我必认真学习。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lamda.xin', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '智算科技, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '596731003@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 赣ICP备2023004219', // 备案号 赣ICP备2023004219
